 ...
 */
public class Main implements TerminalReader, WriterToFile{
    public static void main(String[] args) throws IOException {
        new Menu().start();
        String[] userInputArray = TerminalReader.getUserInput();
        Person person = Validator.checkUserInput(userInputArray);
        System.out.println("Вы набрали:");
        System.out.println(new PersonIterator(person));
        WriterToFile.createFileTxt(person);
    }
}